...
const DEFAULT_HERO = {
  ...
  description:
    'Revolutionary development platform that combines AI assistance with enterprise-grade infrastructure. Build, deploy, and scale applications with unprecedented speed and reliability.',
  features: [
    'AI-assisted coding',
